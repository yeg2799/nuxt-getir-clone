...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Getir - Dakikalar İçinde Kapınızda","htmlAttrs":{"lang":"en"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"https:\u002F\u002Fgetir.com\u002Fimages\u002Ficons\u002Ffavicon-32x32.png"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_c9547740 === 'function') {
    await nuxt_plugin_plugin_c9547740(app.context, inject)
  }
  ...
  if (typeof nuxt_plugin_nuxtsvgsprite_7ffe01d8 === 'function') {
    await nuxt_plugin_nuxtsvgsprite_7ffe01d8(app.context, inject)
  }

  if (typeof nuxt_plugin_image_67ba7c71 === 'function') {
    await nuxt_plugin_image_67ba7c71(app.context, inject)
  }
  ...
  if (typeof nuxt_plugin_meta_45fbfb4c === 'function') {
    await nuxt_plugin_meta_45fbfb4c(app.context, inject)
  }
